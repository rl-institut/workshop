...
# TODO: To make this an investment optimization, remove the nominal_value and
# pass an Investment object instead. You can use oemof's annuity method to 
# pre-calculate equivalent periodical costs of the investment.
